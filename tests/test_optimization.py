...
class TestGeometryOptimization:
    ...
    def test_scf_optimization_label_only(self, water_coords):
        """Test SCF geometry optimization"""
        # Run optimization with a smaller basis set for speed
        result = optimize_geometry_scf(
            coords_string=water_coords,
    ...
    def test_optimization_with_invalid_spin(self, water_coords):
...
class TestLongRunningOptimization:
    ...
    def test_optimization_convergence(self, water_coords):
